      ...
      <section className="diagnosis-control-panel">
        ...
        <div className="diagnosis-mode-grid">
          {[
            ...
            ['HYBRID_GEMINI', 'Gemini + ML fallback', 'Gemini classifies the redacted vector. Local ML takes over on any timeout, invalid output, or outage. Every resulting recovery proposal requires operator approval.', 'LIVE'],
        ...
        <footer><span><b>Privacy boundary</b> No IDs, phone, email, UPI address, notes, card data, amount, or customer fields are sent; requests are stateless.</span><span><b>Outage boundary</b> Bounded timeout · circuit breaker · schema validation · local ML fallback.</span><span><b>Authority boundary</b> Gemini has no Razorpay credentials, tools, or execution access. An operator must approve or reject each Hybrid proposal.</span></footer>
      </section>
